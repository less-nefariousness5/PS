...
---@class game_object
---@field is_channeling               fun(self: game_object): boolean                            -- True if channeling (active channel id > 0)
---@field is_casting                  fun(self: game_object): boolean                            -- True if casting a non-channel spell
